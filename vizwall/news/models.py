...
from vizwall.settings import UPLOAD_ROOT, NEWS_UPLOAD_URL, NEWS_UPLOAD_ROOT
import datetime
...
class News(models.Model):
  ...
  image = models.ImageField(upload_to='news/', default=NEWS_UPLOAD_ROOT+'news/default_picture.jpg', help_text='Select an image to upload', storage=upload_storage)
  image_thumb = models.ImageField(upload_to='/media/news/thumbs', default=NEWS_UPLOAD_ROOT+'news/default_picture_thumb.jpg', help_text='Thumbnail image should be 80px x 80px')
