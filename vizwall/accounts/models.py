...
class UserProfile(models.Model):
  ...
  picture = models.ImageField(upload_to='accounts/', default=ACCOUNTS_UPLOAD_URL+'default_profile.jpg', storage=upload_storage)
  picture_thumb = models.ImageField(upload_to='accounts/', default=ACCOUNTS_UPLOAD_URL+'default_profile_thumb.jpg', storage=upload_storage)
